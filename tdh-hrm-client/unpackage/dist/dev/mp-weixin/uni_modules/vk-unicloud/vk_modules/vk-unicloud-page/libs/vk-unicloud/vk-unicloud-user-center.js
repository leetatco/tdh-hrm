...
const uni_modules_vkUnicloud_vk_modules_vkUnicloudPage_libs_vkUnicloud_vkUnicloudCallFunctionUtil = require("./vk-unicloud-callFunctionUtil.js");
const uni_modules_vkUnicloud_vk_modules_vkUnicloudPage_libs_function_debounce = require("../function/debounce.js");
let { callFunction, config, saveToken, deleteToken } = uni_modules_vkUnicloud_vk_modules_vkUnicloudPage_libs_vkUnicloud_vkUnicloudCallFunctionUtil.callFunctionUtil;
...
function addAppid(obj) {
  if (!obj.data)
    obj.data = {};
  if (!obj.data.appid) {
    obj.data.appid = common_vendor.index.getAccountInfoSync().miniProgram.appId;
  }
  return obj;
}
const userCenter = {
  ...
  getAppleCode(data = {}) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const getUserInfoRes = await common_vendor.index.getUserInfo({
          provider
        });
