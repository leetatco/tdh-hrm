...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: $options.uText,
    h: $props.showSex && $props.sexIcon
  }, $props.showSex && $props.sexIcon ? common_vendor.e({
    i: $props.sexIcon
  }, $props.sexIcon ? {
    j: common_vendor.p({
      name: $props.sexIcon,
    ...
    k: common_vendor.n("u-avatar__sex--" + $props.sexIcon),
    l: common_vendor.s($options.uSexStyle)
  }) : {}, {
    m: $props.showLevel
  }, $props.showLevel ? {
    n: common_vendor.p({
    ...
    o: common_vendor.s($options.uLevelStyle)
  } : {}, {
    p: common_vendor.s($options.wrapStyle),
    q: common_vendor.o((...args) => $options.click && $options.click(...args))
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-49012a02"]]);
