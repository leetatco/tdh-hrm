	...
	export default {
		data() {
			...
			return {
				...
				table1: {
					// 表格数据请求地址
					action: "admin/crm/subsidies/sys/getList",
					// 表格字段显示规则
					columns: [
						{"key":"_id","title":"文档ID，系统自动生成","type":"text","width":200},
						{"key":"company_id","title":"关联企业ID","type":"text","width":200},
						{"key":"subsidy_time","title":"时间","type":"time","width":200},
						{"key":"project_name","title":"项目名称","type":"text","width":200},
						{"key":"subsidy_amount","title":"补贴额","type":"text","width":200},
						{"key":"subsidy_target","title":"补贴对象","type":"text","width":200},
						{"key":"subsidy_introduction","title":"补贴介绍","type":"text","width":200},
				...
				queryForm1: {
					...
					columns: [
						...
						{"key":"subsidy_time","title":"时间","type":"datetimerange","width":200,"mode":"="},
						//{"key":"project_name","title":"项目名称","type":"text","width":200,"mode":"="},
						//{"key":"subsidy_amount","title":"补贴额","type":"text","width":200,"mode":"="},
						//{"key":"subsidy_target","title":"补贴对象","type":"text","width":200,"mode":"="},
						//{"key":"subsidy_introduction","title":"补贴介绍","type":"text","width":200,"mode":"="},
				...
				form1: {
					...
					props: {
						...
						columns: [
							{"key":"company_id","title":"关联企业ID","type":"text","width":200},
							{"key":"subsidy_time","title":"时间","type":"date","dateType":"datetime","width":200},
							{"key":"project_name","title":"项目名称","type":"text","width":200},
							{"key":"subsidy_amount","title":"补贴额","type":"text","width":200},
							{"key":"subsidy_target","title":"补贴对象","type":"text","width":200},
							{"key":"subsidy_introduction","title":"补贴介绍","type":"text","width":200},
		...
		methods: {
			...
			addBtn() {
				this.resetForm();
				this.form1.props.action = 'admin/crm/subsidies/sys/add';
			...
			// 显示修改页面
			updateBtn({ item }) {
				this.form1.props.action = 'admin/crm/subsidies/sys/update';
			...
			deleteBtn({ item, deleteFn }) {
				deleteFn({
					action: "admin/crm/subsidies/sys/delete",
					data: {
						_id: item._id
					},
				});
