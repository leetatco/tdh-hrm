...
<script>
	...
	export default {
			...
			return {
				...
				queryForm1: {
					...
					columns: [{
						...
						//{"key":"update_date","title":"更新时间","type":"text","width":colWidth,"mode":"="},
		...
		methods: {
			...
			addBtn() {
				this.resetForm();
				this.form1.props.action = 'admin/hrm/point/sys/add';
			...
			updateBtn({
				...
				this.form1.props.action = 'admin/hrm/point/sys/update';
			...
			deleteBtn({
				...
				deleteFn({
					action: "admin/hrm/point/sys/delete",
					data: {
						_id: item._id
					},
				});
