	...
	<view class="page-body">
		...
		<vk-data-dialog v-model="form1.props.show" :title="form1.props.title" width="580px" top="4vh" mode="form">
			<vk-data-form ref="form1" v-model="form1.data" :rules="form1.props.rules" :action="form1.props.action"
				:form-type="form1.props.formType" :columns='form1.props.columns' label-width="120px" max-height="700px"
						...
						columns: [{
							...
							},
							{
								...
								watch: ({
									...
									this.$set(formData, 'nickname', option.employee_name);
									this.$set(formData, 'mobile', option.mobile);
									this.$set(formData, 'gender', option.gender);
								}
