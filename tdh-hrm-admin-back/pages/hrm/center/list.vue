...
<script>
	...
	export default {
		data() {
			...
			return {
				...
				table1: {
					...
					// 表格字段显示规则
					columns: [						
						{"key":"center_id","title":"中心编码","type":"text","width":200},
						{"key":"center_name","title":"中心名称","type":"text","width":200},
				...
				queryForm1: {
					...
					columns: [						
						{"key":"center_id","title":"中心编码","type":"text","width":200,"mode":"%%"},
						{"key":"center_name","title":"中心名称","type":"text","width":200,"mode":"%%"},
		...
		methods: {
			...
			addBtn() {
				this.resetForm();
				this.form1.props.action = 'admin/hrm/center/sys/add';
			...
			// 显示修改页面
			updateBtn({ item }) {
				this.form1.props.action = 'admin/hrm/center/sys/update';
			...
			deleteBtn({ item, deleteFn }) {
				deleteFn({
					action: "admin/hrm/center/sys/delete",
					data: {
						_id: item._id
					},
				});
