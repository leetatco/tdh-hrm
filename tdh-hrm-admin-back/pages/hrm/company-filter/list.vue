<template>
	<view class="page-body">
		...
		<vk-data-table ref="table1" :action="table1.action" :columns="table1.columns" :query-form-param="queryForm1"
			:right-btns="['detail_auto','update','delete']" :selection="true" :row-no="false" :pagination="true"
	...
	export default {
		data() {
			...
			return {
				...
				table1: {
					// 表格数据请求地址
					action: "admin/hrm/company-filter/sys/getList",
					// 表格字段显示规则
					columns: [{
							"key": "roles",
							"title": "不拦截角色",
		...
		methods: {
			...
			addBtn() {
				this.resetForm();
				this.form1.props.action = 'admin/hrm/company-filter/sys/add';
			...
			updateBtn({
				...
				this.form1.props.action = 'admin/hrm/company-filter/sys/update';
			...
			deleteBtn({
				...
				deleteFn({
					action: "admin/hrm/company-filter/sys/delete",
					data: {
						_id: item._id
					},
				});
